...
export function BiggestOpportunityCard({
  ...
  return (
    <div
      className={`bg-gradient-to-r from-indigo-950/60 via-slate-900/90 to-slate-900 border border-indigo-700/40 rounded-2xl p-5 sm:p-6 shadow-xl relative overflow-hidden ${className}`}
    >
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 relative z-10">
        <div className="space-y-1.5 max-w-2xl">
          <div className="flex items-center space-x-2">
            <span className="inline-flex items-center text-[10px] font-extrabold uppercase tracking-widest text-indigo-400 bg-indigo-950 border border-indigo-800 px-2.5 py-0.5 rounded-full">
        ...
        {onTakeAction && (
          <button
            ...
            className="shrink-0 px-4 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-bold flex items-center shadow-lg shadow-indigo-600/30 transition-all cursor-pointer"
          >
